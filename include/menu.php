...
if (!isset($_SESSION["mikhmon"])) {
  ...
  if ($hotspot == "dashboard" || substr(end(explode("/", $url)), 0, 8) == "?session") {
    ...
    $schmenu = "menu-open";
  } elseif ($report == "selling" || $report == "resume-report" || $report == "recap-report") {
    $sselling = "active";
    $mpage = $_report;
    ...
    $seditor = "active";
    $mpage = $_template_editor;
  } elseif ($systool == "emailbkp") {
    $toolsmenu = "active";
    $tlsmenu = "menu-open";
    $emailm = "active";
  }elseif ($systool == "netwatch" || $netwatch == "add-netwatch" || $netwatch == "set-telegram-netwatch") {
    $toolsmenu = "active";
    $tlsmenu = "menu-open";
    $netwatchm = "active";
  }elseif ($hotspot == "user-profiles-tree") {
    $suserprofilestree = "active";
    $suserproftree = "active";
    $mpage = $_user_profile_tree;
    $upmenutree = "menu-open";
  }elseif ($userprofiletree == "add") {
    $suserproftree = "active";
    $sadduserproftree = "active";
    $mpage = $_user_profile_tree;
    $upmenutree = "menu-open";
...
<div id="sidenav" class="sidenav">
  ...
  <!--hotspot-->
  <div class="dropdown-btn <?= $susers . $suserprof . $suserproftree . $sactive . $shosts . $sipbind . $scookies; ?>"><i class="fa fa-wifi"></i> Hotspot
    <i class="fa fa-caret-down"></i>
  </div>
  <div class="dropdown-container <?= $umenu . $upmenu . $upmenutree . $hamenu . $hmenu . $ibmenu . $cmenu; ?>">
   <!--users--> 
  ...
  <!--tool-->
  <div class="dropdown-btn <?php echo $toolsmenu;?>"><i class=" fa fa-wrench"></i> <?= $_tools?>
    <i class="fa fa-caret-down"></i> &nbsp;
  </div>
  <div class="dropdown-container <?php echo $tlsmenu;?>">
    <a href="./?systool=emailbkp&session=<?php echo $session;?>" class="menu <?php echo $emailm;?>"><i class=" fa fa-envelope"></i> <?= $_email_backup?></a>
    <a href="./?systool=netwatch&session=<?php echo $session;?>" class="menu <?php echo $netwatchm;?>"><i class=" fa fa-eye"></i> <?= $_netwatch?></a>
  </div>
